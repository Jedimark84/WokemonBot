    ...
    try:
        ...
        if re.match('^Raid\s(\d)+$', text_split):
            ...
            if reply_text.startswith('/'):
                ...
                if bot_command == 'time':
                    return bot_command_time(message_id, raid_id)
                if bot_command == 'title':
                    return bot_command_title(message_id, raid_id)
                if bot_command == 'location':
                    return bot_command_location(message_id, raid_id)
            else:
                return leave_comment(message_id, raid_id)
...
def bot_command_cancel(message_id, chat_id, raid_id, from_id):
    ...
    if response.get('success'):
        ...
        for t in tracking:
            ...
            msg.send_message('Raid Cancelled.', chat_id, None)
...
def bot_command_time(message_id, raid_id):
...
def bot_command_title(message_id, raid_id):
...
def bot_command_location(message_id, raid_id):
...
def leave_comment(message_id, raid_id):
